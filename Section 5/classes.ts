...
class SEATeam extends Team {
  private lastReport: string; // class field
  private static instance: SEATeam;
  ...
  static getInstance() {
    ...
    this.instance = new SEATeam("div1", ["SunBhie"], ["Kuku"], ["LMFAOOOOO"]);
  }
...
const Talon = SEATeam.getInstance() as SEATeam;
